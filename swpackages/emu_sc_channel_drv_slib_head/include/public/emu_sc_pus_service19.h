...
class Program19_1TC_with_3_31:public ProgramTC{

public:

  Program19_1TC_with_3_31(uint32_t uniTime2YK,
                char * brief,
                uint16_t RID,
                uint16_t SID,
                uint16_t interval);
...
class Program19_1TC_with_20_3:public ProgramTC{

public:

  Program19_1TC_with_20_3(uint32_t uniTime2YK,
                char * brief,
                uint16_t RID,
                uint16_t index,
                uint64_t paramValue);
